...
const handleAIDetection = async (payload: { content: string }) => {
  ...
  const systemPrompt = `You are an AI content detector. Analyze the given text and determine if it was likely generated by AI.

Consider these factors:
1. Writing patterns typical of AI (overly structured, repetitive phrases)
2. Lack of personal experiences or emotions
3. Generic or templated responses
4. Perfect grammar without natural human errors
5. Overuse of buzzwords or corporate speak
6. Lack of cultural references or slang
...
Return only the confidence score as a decimal number (e.g., 0.85).`;
